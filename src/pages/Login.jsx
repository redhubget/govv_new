...
export default function Login() {
  ...
  const send = async () => {
    ...
    try {
      ...
      setSent(true)
      setInfo('OTP sent. Check your SMS/Email.')
    } catch (e) {
    ...
    <div className="container">
      <div className="card" style={{ maxWidth: 480, margin: '20px auto' }}>
        ...
        {!sent ? (
          ...
          <>
            {/* OTP input */}
            <label style={{ display: 'block', fontSize: 13, marginTop: 16, marginBottom: 6, color: 'var(--muted)' }}>
              Enter OTP
            </label>
            <input
              className="input"
              ...
              onKeyDown={(e) => { if (e.key === 'Enter' && otpValid && !loading) verify() }}
            />
